...
<br>
 <?php 
  //Count(), kjo metode na mundeson te gjejme gjatesine e array.
    $x = array("Shkolla","Digjitale","Prizren");
...
<br>
    ...
    //I pari eshte qelesi ndersa e dyta vlera, p.sh "Sumeja" eshte qelesi, ndersa "17" eshte vlera
      $mosha = array("Sumeja"=>17, "Arianit"=>26, "Fatjona"=>26);

      echo "Sumeja eshte " . $mosha['Sumeja'] . "vjeq.";
?>
<br>
...
<h3>sort()</h3>
    ...
    //sort(), kjo metode na mundeson qe ta renditim elementet e nje Array, nga numri me i vogel.
...
//$text = array("Shkolla","Digjitale","Prizren");
    $text = array("Shkolla","Digjitale","Prizren","Sumeja");
